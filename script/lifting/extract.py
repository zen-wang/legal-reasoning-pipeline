...
MODEL_CONTEXT_LIMIT = 65536  # vLLM --max-model-len (covers ~98% of opinions untruncated)
PROMPT_TEMPLATE_TOKENS = 2100  # system prompt + instructions + few-shot + schema + chat template overhead
